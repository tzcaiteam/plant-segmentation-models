...
def parse_args():
    ...
    # parser.add_argument('--root', type=str, default='/home/felicia/datasets/pepper/pepper/',
    #                     help='dataset name')
    parser.add_argument('--root', type=str, default=r'D:\jht_datasets\pepper2\pepper\pepper',
                        help='dataset name')

    parser.add_argument('--model_type', default='Iteration',type=str,
                        help='dataset name')
    parser.add_argument('--filesname', default='pepper_pepper',type=str,
                        help='dataset name')
