...
from models.ours.DoubleMLPUNet import DoubleMLPUNet_ACAM
...
def parse_args():
    ...
    # model
    parser.add_argument('--arch', '-a', metavar='ARCH', default='DoubleMLPUNet',
                        choices=ARCH_NAMES,
    ...
    #                     help='dataset name')
    parser.add_argument('--root', default='/home/felicia/datasets/satellite_forest/AMAZON_FOREST/',
                        help='dataset name')
    parser.add_argument('--dataset', default='AMAZON_FOREST',
                        help='dataset name')
...
def main():
    ...
    elif model_name == 'DoubleMLPUNet':
        model = DoubleMLPUNet_ACAM(config['input_channels'], config['num_classes'])
    else:
