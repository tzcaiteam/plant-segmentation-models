...
class UTNet(nn.Module):
    def __init__(self, n_channels, base_chan, num_classes=1, reduce_size=8, block_list='234'):
        super().__init__()
        ...
        self.inc = [BasicBlock(n_channels, base_chan)]
        if '0' in block_list:
...
class UTNet_Encoderonly(nn.Module):
    ...
    def __init__(self, in_chan, base_chan, num_classes=1, reduce_size=8, block_list='234'):
        super().__init__()
