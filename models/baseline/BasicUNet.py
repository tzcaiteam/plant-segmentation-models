...
# 常用的模型有：UNet、R2U_Net、AttU_Net、R2AttU_Net、NestedUNet
########################################################################################################################
...
class R2U_Net(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=1,  deep_supervision=False,t=2):
...
class NestedUNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, deep_supervision=False, **kwargs):
        super().__init__()
        ...
        self.conv0_0 = conv_block_nested(n_channels, nb_filter[0], nb_filter[0])
