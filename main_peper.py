...
# from models.DoubleMLPUNet import DoubleMLPUNet, DoubleMLPUNet_UpAtt, DoubleMLPUNet_Att_Layer5, DoubleMLPUNet_DownAtt, \
#     DoubleMLPUNet_ACAM
...
def parse_args():
    ...
    # model
    parser.add_argument('--arch', '-a', metavar='ARCH', default='Sim_Net',
                        choices=ARCH_NAMES,
    ...
    #                     help='dataset name')
    parser.add_argument('--root', default='H:\\dataset\\pepper\\zaoyibing\\',
                        help='dataset name')
...
def main():
    ...
    if model_name == 'UNet':
        from models.U_Net import U_Net as net
        ...
        #from models.network_scunet import MBFUNet_C as net
        from models.MLP.Conv_mlp_multiaxis import MLPGLUNet as net
        model = net(in_nc=3, config=[2, 2, 2, 2, 2, 2, 2], dim=16)
    elif model_name == "SHAU_Net":
        from models.AATU_Net import SHAU_Net as net
        model = net(in_ch=3,out_ch=1)
    else:
