...
import losses
from demo.dataset import Dataset
from metrics import iou_score,dice_coef,accuracy_score
from utils import AverageMeter, str2bool
from models.TransMUNet import TransMUNet
...
def parse_args():
    ...
    # model
    parser.add_argument('--arch', '-a', metavar='ARCH', default='TransMUNet',
                        choices=ARCH_NAMES,
    ...
    parser.add_argument('--root', default='/home/felicia/datasets/Satellite-Sensor-Imagery/Amazon Forest Dataset/',
                        help='dataset name')
    parser.add_argument('--dataset', default='ATLANTIC FOREST',
                        help='dataset name')
