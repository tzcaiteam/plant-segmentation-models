...
def parse_args():
    ...
    parser.add_argument('--model_path', default='/home/felicia/project_pytorch/pytorch-nested-unet-master/',
                        help='model path')
    parser.add_argument('--model_name', default='bingdu_Pepper_SwinUNet',
                        help='model name')
    parser.add_argument('--test_path', default='/home/felicia/datasets/bingdu/bingdu/Test/',
...
def main():
    ...
    path_test = '/home/felicia/datasets/pepper/bingdu/Test/'
