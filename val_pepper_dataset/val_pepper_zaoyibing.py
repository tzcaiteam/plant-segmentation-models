...
def parse_args():
    ...
    parser.add_argument('--model_path', default='/home/felicia/iterative_pepper/plant-segmegmentation-models/model_output/pepper_zaoyibing/Iteration/',
                        help='model path')
    parser.add_argument('--valResult_path', default='/home/felicia/iterative_pepper/plant-segmegmentation-models/val_output/pepper_zaoyibing/Iteration/',
                        help='model path')
    parser.add_argument('--model_name', default='potsdam_ResNet_UTNet_woDS',
                        help='model name')
    parser.add_argument('--test_path', default='/home/felicia/datasets/pepper/zaoyibing/Test/',     #image  label
